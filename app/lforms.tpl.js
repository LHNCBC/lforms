angular.module('lformsWidget').run(['$templateCache', function($templateCache) {
  ...
  $templateCache.put('form-view-a.html',
    ...
    "                  <tr style=\"width: 99%\"\n" +
    "                      class=\"repeatingLine {{ getSkipLogicClass_New(item) }} {{getRowClass(item)}} \"\n" +
    ...
    "                      <table class=\"t-treeline-field\" >\n" +
    "                        <tr>\n" +
    "                          <td class=\"t-treeline \" ng-class=\"getExtraRowTreeLevelClass2($index, item._lastSiblingList)\" ng-repeat=\"lastStatus in item._lastSiblingList track by $index\"> &nbsp; </td>\n" +
    "                          <td>\n" +
    "                            <div class=\"name_label\">\n" +
    "                              <span>&nbsp;</span>\n" +
    "                            </div>\n" +
