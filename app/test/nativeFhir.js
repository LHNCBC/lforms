// Built from fhir.js.  Copied here to avoid adding a build step just for the
// a file needed by the test code, and to avoid adding the fhir.js dependencies
// (many of which are out of date).
