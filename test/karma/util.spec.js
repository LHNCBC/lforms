...
describe('Util library', function() {
  ...
  describe('LForms.Util._internalUtil.checkForInvalidHtmlTags()', () => {
    ...
    it('should find the invalid style attribute', () => {
      ...
      invalidTagsAttributes = LForms.Util._internalUtil.checkForInvalidHtmlTags(sourceHTML);
      ...
      srcHTMLs.forEach(srcHTML => {
        let invalidTagsAttributes = LForms.Util._internalUtil.checkForInvalidHtmlTags(srcHTML);
        assert.equal(invalidTagsAttributes.length, 0);
      })
    ...
    it('should pass the basic-example-narrative from fhir website', () => {
      ...
      let invalidTagsAttributes = LForms.Util._internalUtil.checkForInvalidHtmlTags(basicExample);
      assert.equal(invalidTagsAttributes.length, 0);
    })
  })
