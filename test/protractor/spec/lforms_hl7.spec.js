...
describe('HL7 data', function() {
  ...
  it('should get correct hl7 data', function() {
    ...
    browser.driver.executeAsyncScript(function () {
      ...
      expect(hl7).toBe("OBR||54127-6N^USSG-FHT, (with mock-up items for skip logic demo)^LN|OBX||ST|54125-0^Name^LN|1.a|name2|OBX||ST|54125-0^Name^LN|1.b|name3|OBX||CNE|54131-8^Gender^LN|1|LA2-8^Male^LN|OBX||DT|21112-8^Date of Birth^LN|1|2016-10-27T00:00:00-04:00|OBX||NM|8302-2^Height^LN|1|70|inches^inches^LN|OBX||NM|29463-7^Weight^LN|1|170|lbs^lbs^LN|OBX||ST|39156-5^Mock-up item: Body mass index (BMI) [Ratio]^LN|1|24.39|OBX||CNE|54134-2^Race^LN|1|LA10608-0^American Indian or Alaska Native^LN~LA6156-9^Asian^LN|OBX||CNE|54140-9^Disease or Condition^LN|1.1a|LA10572-8^-- Blood Clot in Leg^LN|OBX||CNE|54130-0^Age at Diagnosis^LN|1.1a|LA10394-7^Infancy^LN|OBX||CNE|54140-9^Disease or Condition^LN|1.1b|LA10573-6^-- Blood Clot in Lungs^LN|OBX||CNE|54130-0^Age at Diagnosis^LN|1.1b|LA10395-4^Childhood^LN|OBX||ST|54138-3^Name^LN|2a|member name1|OBX||CNE|54116-9^Disease or Condition^LN|2a.1a|LA10533-0^Blood Clots^LN|OBX||ST|54138-3^Name^LN|2b|member name2|OBX||CNE|54116-9^Disease or Condition^LN|2b.1a|LA10572-8^-- Blood Clot in Leg^LN|");
    });
  });
});
