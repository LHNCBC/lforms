...
test.describe('Questionnaire with readOnly and repeats items', () => {
  test('should show disabled "+" button', async ({ page }) => {
    ...
    await expect(byId(page, 'add-q1/1')).toBeVisible();
    await expect(byId(page, 'add-q1/1')).toBeDisabled();
    await expect(byId(page, 'add-g1q1/1/1')).toBeVisible();
    await expect(byId(page, 'add-g1q1/1/1')).toBeDisabled();
    ...
    await expect(byId(page, 'add-q1/2')).toBeVisible();
    await expect(byId(page, 'add-q1/2')).toBeDisabled();
    await expect(byId(page, 'del-q1/1')).toBeVisible();
    await expect(byId(page, 'del-q1/1')).toBeDisabled();
    await expect(byId(page, 'q1/1')).toBeVisible();
    await expect(byId(page, 'q1/1')).toBeDisabled();
    await expect(byId(page, 'q1/1')).toHaveValue('aaa');
    await expect(byId(page, 'del-q1/2')).toBeVisible();
    await expect(byId(page, 'del-q1/2')).toBeDisabled();
    await expect(byId(page, 'q1/2')).toBeVisible();
    await expect(byId(page, 'q1/2')).toBeDisabled();
    await expect(byId(page, 'q1/2')).toHaveValue('bbb');

    await expect(byId(page, 'add-g1q1/1/2')).toBeVisible();
    await expect(byId(page, 'add-g1q1/1/2')).toBeDisabled();
    await expect(byId(page, 'del-g1q1/1/1')).toBeVisible();
    await expect(byId(page, 'del-g1q1/1/1')).toBeDisabled();
    await expect(byId(page, 'g1q1/1/1')).toBeVisible();
    await expect(byId(page, 'g1q1/1/1')).toBeDisabled();
    await expect(byId(page, 'g1q1/1/1')).toHaveValue('ccc');
    await expect(byId(page, 'del-g1q1/1/2')).toBeVisible();
    await expect(byId(page, 'del-g1q1/1/2')).toBeDisabled();
    await expect(byId(page, 'g1q1/1/2')).toBeVisible();
    await expect(byId(page, 'g1q1/1/2')).toBeDisabled();
    await expect(byId(page, 'g1q1/1/2')).toHaveValue('ddd');
  });
});
