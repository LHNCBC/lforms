...
test.describe('load saved user data', () => {
  ...
  test('skip logic should work with loaded user data', async ({ page }) => {
    ...
    await expect(byId(page, '/slTargetItem2/1')).toHaveValue('200');
    await expect(byId(page, '/slTargetHeader1/slTargetSubItem1/1/1')).toBeVisible();
    await expect(byId(page, '/slTargetHeader1/slTargetSubItem1/1/1')).toHaveValue('201');
    await expect(byId(page, '/slTargetHeader1/slTargetSubItem2/1/1')).toBeVisible();
    await expect(byId(page, '/slTargetHeader1/slTargetSubItem2/1/1')).toHaveValue('202');
  });

  test('repeating items should be shown', async ({ page }) => {
    await openFormByIndex(page, 7); // FormWithUserData
    await expect(byId(page, '/rp-q1/1')).toBeVisible();
    await expect(byId(page, '/rp-q1/1')).toHaveValue('instance A');
    await expect(byId(page, '/rp-q1/2')).toBeVisible();
    await expect(byId(page, '/rp-q1/2')).toHaveValue('instance B');
    await expect(byId(page, 'add-/rp-q1/2')).toBeVisible();
    await expect(byId(page, 'add-/rp-q1/2')).toContainText('+ A Repeating Item');
  });
  ...
  test('repeating items/section within a repeating section should be shown', async ({ page }) => {
    ...
    await expect(byId(page, '/rp-q2/rp-q3/1/1')).toBeVisible();
    await expect(byId(page, '/rp-q2/rp-q3/1/1')).toHaveValue('300');
    await expect(byId(page, '/rp-q2/rp-q3/2/1')).toBeVisible();
    await expect(byId(page, '/rp-q2/rp-q3/2/1')).toHaveValue('301');
    ...
    await expect(byId(page, '/rp-q2/rp-q4/rp-q5/1/1/1')).toBeVisible();
    await expect(byId(page, '/rp-q2/rp-q4/rp-q5/1/1/1')).toHaveValue('400');
    await expect(byId(page, '/rp-q2/rp-q4/rp-q5/1/2/1')).toBeVisible();
    await expect(byId(page, '/rp-q2/rp-q4/rp-q5/1/2/1')).toHaveValue('401');
    await expect(byId(page, '/rp-q2/rp-q4/rp-q5/1/3/1')).toBeVisible();
    await expect(byId(page, '/rp-q2/rp-q4/rp-q5/1/3/1')).toHaveValue('402');
    await expect(byId(page, '/rp-q2/rp-q4/rp-q5/2/1/1')).toBeVisible();
    await expect(byId(page, '/rp-q2/rp-q4/rp-q5/2/1/1')).toHaveValue('403');

    await expect(byId(page, 'add-/rp-q2/rp-q4/1/3')).toBeVisible();
    await expect(byId(page, 'add-/rp-q2/rp-q4/1/3')).toContainText('+ A repeating section in a repeating section');
    await expect(byId(page, 'add-/rp-q2/rp-q4/2/1')).toBeVisible();
    await expect(byId(page, 'add-/rp-q2/rp-q4/2/1')).toContainText('+ A repeating section in a repeating section');
    await expect(byId(page, 'add-/rp-q2/2')).toBeVisible();
    await expect(byId(page, 'add-/rp-q2/2')).toContainText('+ A Repeating Section');

    await expect(byId(page, 'del-/rp-q2/rp-q4/1/3')).toBeVisible();
    await expect(byId(page, 'del-/rp-q2/rp-q4/1/3')).toHaveText('-');
    await expect(byId(page, 'del-/rp-q2/2')).toBeVisible();
    await expect(byId(page, 'del-/rp-q2/2')).toHaveText('-');
  });
  ...
  test('form should be actionable', async ({ page }) => {
    ...
    await expect(byId(page, 'add-/rp-q1/2')).not.toBeAttached();
    await expect(byId(page, 'add-/rp-q1/3')).toBeVisible();
    await expect(byId(page, 'add-/rp-q1/3')).toContainText('+ A Repeating Item');
    await expect(byId(page, '/rp-q1/3')).toHaveValue('');

    // add a repeating section
    await byId(page, 'add-/rp-q2/rp-q4/1/3').click();
    await expect(byId(page, 'add-/rp-q2/rp-q4/1/3')).not.toBeAttached();
    await expect(byId(page, 'add-/rp-q2/rp-q4/1/4')).toBeVisible();
    await expect(byId(page, 'add-/rp-q2/rp-q4/1/4')).toContainText('+ A repeating section in a repeating section');
  ...
  test('adding a repeating section that has repeating sub items with user data should show just one repeating item', async ({ page }) => {
    ...
    await expect(byId(page, '/rp-q2/rp-q3/3/1')).toBeVisible();
    await expect(byId(page, '/rp-q2/rp-q3/3/1')).toHaveValue('');
    await expect(byId(page, '/rp-q2/rp-q4/rp-q5/3/1/1')).toBeVisible();
    await expect(byId(page, '/rp-q2/rp-q4/rp-q5/3/1/1')).toHaveValue('');
