      ...
      if (item._modifiedAnswers) {
        ...
        if (userValues) {
          ...
          for (var k = 0, kLen = userValues.length; k < kLen; ++k) {
            var userValue = userValues[k]; // // fieldKey is code, text, or label (code is unique if present. text and label are not required to be unique)
